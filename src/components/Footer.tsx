            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                <ul className="pl-4 space-y-2 border-l border-background/20">
                  <li>
                    <Link to="/missoes/brasil" className="text-background/70 hover:text-primary transition-colors">
                      Brasil
                    </Link>
                  </li>
                  <li>
                    <Link to="/missoes/australia" className="text-background/70 hover:text-primary transition-colors">
                      Austrália
                    </Link>
                  </li>
                </ul>
