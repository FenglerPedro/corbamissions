...
import corbaLogo from "@/assets/corba-logo.png";
...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full flex justify-center transition-all duration-500 ease-out">
      ...
      >
        {/* Logo */}
        <Link to="/" className="flex items-center z-50 shrink-0" onClick={closeMenu}>
          <img
            src={corbaLogo}
            alt="Corbã Missions"
            className={cn(
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="center" className="min-w-[150px] p-2 rounded-xl bg-background/95 backdrop-blur-md border-border">
              <DropdownMenuItem asChild>
                <Link to="/missoes/brasil" className="w-full cursor-pointer rounded-lg px-4 py-2 hover:bg-muted font-medium">Brasil</Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link to="/missoes/australia" className="w-full cursor-pointer rounded-lg px-4 py-2 hover:bg-muted font-medium">Austrália</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
